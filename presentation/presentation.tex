...
\title[Linux essentials]{Linux Essentials workshops} % The short title appears at the bottom of every slide, the full title is only on the title page

\author{M. Afkani} % Your name
\institute[Kharazmi University] % Your institution as it will appear on the bottom of every slide, may be shorthand to save space
{
Kharazmi University of Tehran \\ % Your institution for the title page
\medskip
\textit{afkani.ir} % Your email address
}
...
%------------------------------------------------
\section{What Is Linux?} % Sections can be created in order to organize your presentation into discrete blocks, all sections and subsections are automatically printed in the table of contents as an overview of the talk
%------------------------------------------------
\begin{frame}
...
\end{wrapfigure}
%\includegraphics[scale=.35]{Linus_Torvalds.jpg}
...
\frametitle{shell it self!}
    \includegraphics[width=0.25\textwidth]{bash.jpg}
\begin{itemize}
...
\begin{frame}
\frametitle{\$ echo}
\fcolorbox{black}{gray!20}{\$ echo Hello} \par
\vspace{0.15cm}
\fcolorbox{black}{gray!20}{\$ echo Hello \#Comment} \par
\vspace{0.15cm}
\fcolorbox{black}{gray!20}{\$ echo -e "Hello \textbackslash n World"}
\begin{table}
\begin{tabular}{l l}
\toprule
...
\begin{frame}\frametitle{\$ echo}
\fcolorbox{black}{gray!20}{\$ echo line 1 ; echo line 2 ; echo line 3} \par
\vspace{0.15cm}
\fcolorbox{black}{gray!20}{\$ echo line 1 \&\&echo line 2 \&\& echo line 3} \par
\vspace{0.15cm}
\fcolorbox{black}{gray!20}{\$ echo line 1 $||$ echo line 2 ; echo line 3}
\end{frame}
